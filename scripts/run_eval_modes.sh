...
python eval/eval.py \
  ...
  --model "$MODEL" \
  --benchmark "$BENCHMARK" \
  --out evaluation_reports/eval_report_demo_mode.json \
  --verbose
...
python eval/eval.py \
  ...
  --model "$MODEL" \
  --benchmark "$BENCHMARK" \
  --out evaluation_reports/eval_report_honest_mode.json \
...
for path in ["evaluation_reports/eval_report_demo_mode.json", "evaluation_reports/eval_report_honest_mode.json"]:
